...
export default function News() {
  ...
  const categories = [
    ...
    { id: 'modern', name: 'Panafricanisme moderne' }
  ]
  
  // Articles sur le panafricanisme
  const articles = [
    {
      id: 1,
  ...
  return (
    <div className="min-h-screen bg-light">
      <Head>
        <title>Actualités | PSP</title>
        <meta name="description" content="Actualités et articles sur le panafricanisme du Parti Socialiste Panafricain" />
      </Head>
      ...
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-2xl font-bold text-center mb-6">Actualités & Histoire du Panafricanisme</h1>
          ...
          {filteredArticles.length > 0 ? (
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="md:flex">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center text-gray-600 text-xs mt-4">
            ...
            <div className="text-center py-10">
              ...
              <button 
                ...
                className="mt-4 py-2 px-4 bg-primary text-white rounded-lg hover:bg-primary-dark"
              >
